        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active">
                <a href="">
                    ...
                    <span class="menu-title" data-i18n="nav.add_on_drag_drop.main">{{__('dashboard.main')}}</span>
                </a>
            </li>
            ...
            <li class="nav-item  open ">
                <a href="">
                    ...
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('dashboard.languages')}}</span>
                    <span class="badge badge badge-info badge-pill float-right mr-2">felo</span>
                </a>
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a class="menu-item" href="" data-i18n="nav.dash.crypto">{{__('dashboard.add_lang')}}</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('dashboard.brand.brands')}}</span>
            ...
            <li class="nav-item">
                <a href="">
                    <i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Product Attributes</span>
                    <span class="badge badge badge-danger  badge-pill float-right mr-2">
            ...
            <li class="nav-item">
                <a href="">
                    <i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Attribute Options</span>
                    <span class="badge badge badge-danger  badge-pill float-right mr-2">
                        {{\App\Models\AttrOption::count()}}
                    </span>
                </a>
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{route('admin.attr_options')}}" data-i18n="nav.dash.ecommerce">
                            {{__('dashboard.show_all')}}
                        </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{route('admin.attr_options.create')}}" data-i18n="nav.dash.crypto">
            ...
            <li class="nav-item">
                <a href="">
                    <i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Slider</span>
                </a>
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{route('admin.sliders.images')}}" data-i18n="nav.dash.ecommerce">
                            Add Slider
                        </a>
                    </li>
                </ul>
            ...
            <li class=" nav-item">
                <a href="#">
                    ...
                    <span class="menu-title" data-i18n="nav.templates.main">Settings</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a class="menu-item" href="#" data-i18n="nav.templates.vert.main">Shipping Methods</a>

                        <ul class="menu-content">
                            <li>
                                <a class="menu-item" href="{{route('edit.shipping.methods', 'free')}}" data-i18n="">
                                    free Shipping
                                </a>
                            </li>
                            <li>
                                <a class="menu-item" href="{{route('edit.shipping.methods', 'inner')}}">inner Shipping</a>
                            </li>

                            <li>
                                <a class="menu-item" href="{{route('edit.shipping.methods', 'out')}}" data-i18n="">
                                    out Shipping
                                </a>
                            </li>
            ...
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a class="menu-item" href="layout-fixed-navbar.html" data-i18n="nav.page_layouts.fixed_navbar">
                            Fixed navbar
                        </a>
                    </li>
                    <li>
