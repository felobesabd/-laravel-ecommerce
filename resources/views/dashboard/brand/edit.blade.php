                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="">{{__('dashboard.brand.main_brands')}}</a>
                                </li>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img src="{{$brand-> photo}}" class="rounded-circle  height-150" alt="photo">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label>{{__('dashboard.brand.photo_brand')}}</label>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>Data Brand</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Name Brand
                                                            </label>
