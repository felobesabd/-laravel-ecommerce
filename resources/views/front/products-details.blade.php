                                                            ...
                                                            @isset($product->categories)
                                                                <div>
                                                                    @foreach($product->categories as $category )
                                                                        <span>
                                                                            <a href="{{route('get.products.by.cat', $category->slug )}}"
                                                        ...
                                                        @if(isset($product_attributes) && count($product_attributes) > 0 )
                                                            @foreach($product_attributes as $attribute)
                                                                <div class="product-variants-item">
                                                                    ...
                                                                    @if(isset($attribute -> attrOptions) && count($attribute -> attrOptions) > 0 )
                                                                        <select id="group_1" data-product-attribute="1"
                                                                                name="{{$attribute -> name}}">
                                                                            @foreach($attribute -> attrOptions as $option)
                                                                                <option value="1" title="{{$option -> name}}"
                                                                                        selected="selected">
                                                                                    {{$option -> name}}
                                                                                </option>
                                                                            @endforeach
                                                    ...
                                                    <div class="product-cat-content">
                                                        <div class="category-title">
                                                            <div class="product-title" itemprop="name">
                                                                <a href="{{route('get.product.details', $_product -> slug)}}">
                                                                    {{$_product -> name}}
                                                                </a>
                                                            </div>
                                                        </div>
